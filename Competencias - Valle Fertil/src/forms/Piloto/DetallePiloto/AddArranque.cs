...
{
    public partial class AddArranque : Form
    {
        
        Stopwatch arranqueAutomatico;
        Participacion piloto;
        detallePiloto formPiloto;
        public AddArranque(object x, ref detallePiloto anterior)
        {
            InitializeComponent();
